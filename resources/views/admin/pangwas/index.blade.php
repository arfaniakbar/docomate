                    ...
                    @forelse ($pangwas_list as $pangwas)
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <form action="{{ route('admin.pangwas.destroy', $pangwas->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('APAKAH ANDA YAKIN INGIN MENGHAPUS DATA WASPANG INI?');">
                                    @csrf
                                    @method('DELETE')
